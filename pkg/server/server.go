...
func (s *Server) CreateBlog(ctx context.Context, req *blogpb.CreateBlogRequest) (*blogpb.CreateBlogResponse, error) {
	...
	res, err := s.db.Db.Collection("blog").InsertOne(ctx, data)
	if err != nil {
...
func (s *Server) ReadBlog(ctx context.Context, req *blogpb.ReadBlogRequest) (*blogpb.ReadBlogResponse, error) {
	...
	res := s.db.Db.Collection("blog").FindOne(ctx, filter)
...
func (s *Server) UpdateBlog(ctx context.Context, req *blogpb.UpdateBlogRequest) (*blogpb.UpdateBlogResponse, error) {
	...
	_, updateErr := s.db.Db.Collection("blog").ReplaceOne(context.Background(), filter, data)
	if updateErr != nil {
		return nil, status.Errorf(
			codes.Internal,
...
func (s *Server) DeleteBlog(ctx context.Context, req *blogpb.DeleteBlogRequest) (*blogpb.DeleteBlogResponse, error) {
	...
	res, err := s.db.Db.Collection("blog").DeleteOne(ctx, filter)
...
func (s *Server) ListBlog(_ *blogpb.ListBlogRequest, stream blogpb.BlogService_ListBlogServer) error {
	...
	cur, err := s.db.Db.Collection("blog").Find(context.Background(), primitive.D{{}})
	if err != nil {
